...
MODEL SHIFT = for_2003 DISURBKM DISRDKM DISSMKM DEN_KM2 ELEV1 SLOPE1 BALIVE1 SICND1 STDAGE1 STDSIZ1 SITECL aspcl2/rsq link = glogit selection = backward slstay=0.15  DETAILS LACKFIT CTABLE EXPB outroc = ROCData pprob= 0.6;
